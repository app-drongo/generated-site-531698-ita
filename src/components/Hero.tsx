...
// Generated: 2025-08-21T23:21:57.048Z
// Section: hero
// Category: hero
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-6">
              ...
              <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                Workflow with TaskFlow Pro
              </span>
            </h1>
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Unlock the power of seamless project management, real-time collaboration, and
              advanced analytics to drive your remote team's success.
            </p>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">TaskFlow Pro Demo</p>
                  </div>
                </div>
              </div>
